...
class LaunchSnowballRun(
    context: SantaContext,
    adapter: LauncherDataChangedCallback
) : AbstractFeatureModuleLaunch(context, adapter, R.string.running, R.drawable.android_game_cards_snowball_run) {

    override val featureModuleNameId: Int = R.string.feature_snowball_run
    ...
    companion object {
        private val CLASS_NAME = "com.google.android.apps.santatracker.doodles.snowballrun.SnowballRunActivity"
    }
}

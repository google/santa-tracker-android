...
/**
 * Support for Google Now (Voice) Actions See
...
public class VoiceAction {
    ...
    public static final String ACTION_PLAY_GAME = "com.google.android.apps.santatracker.PLAY_GAME";
    ...
    private static final String[] SUPPORTED_ACTIONS = {
        SearchIntents.ACTION_SEARCH, ACTION_SHOW_SANTA, ACTION_PLAY_GAME, ACTION_PLAY_RANDOM_GAME
    };

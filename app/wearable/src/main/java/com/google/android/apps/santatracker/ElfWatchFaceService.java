...
/**
 * A watch face with a background that changes depending on time of day, and
 * an elf whose arms rotate independently as the minute and hour hands.
 */
public class ElfWatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        private static final int ELF_FIGURE_OFFSET_X = 5;
        private static final int ELF_FIGURE_OFFSET_Y = 28;
        private static final int ELF_FIGURE_ADDITIONAL_OFFSET_X = -5;
         ...
         * version will be chosen at runtime.
         *
        ...
        public void onSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            mScaledXOffset = ELF_FIGURE_OFFSET_X * mScale;
            mScaledXAdditionalOffset =
                    (ELF_FIGURE_OFFSET_X + ELF_FIGURE_ADDITIONAL_OFFSET_X) * mScale;
            mScaledYOffset = ELF_FIGURE_OFFSET_Y * mScale;
        }

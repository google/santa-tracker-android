...
@Database(
        version = 1,
        entities = [Metadata::class, Destination::class, StreamEntry::class])
abstract class SantaDatabase : RoomDatabase() {

    abstract fun metadata(): MetadataDao

    abstract fun destination(): DestinationDao

    abstract fun stream(): StreamDao
}
